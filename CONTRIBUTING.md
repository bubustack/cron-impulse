# Contributing to cron-impulse

Thank you for considering a contribution—your help keeps this repository healthy for every bobrapet Story.

This guide explains how we work in the `cron-impulse` repository, from filing issues to sending patches.

## How Can I Contribute?

### Reporting Bugs

- Search for an existing report under [Issues](https://github.com/bubustack/cron-impulse/issues).
- If nothing matches, [open a new issue](https://github.com/bubustack/cron-impulse/issues/new) with a clear description, reproduction steps, and both observed and expected behaviour.
...
- Run the quality gates locally:
  - `make lint`
  - `make test`
  - `make docker-build IMG=ghcr.io/<your-user>/cron-impulse:dev` when binaries or Dockerfile paths change
...
2.  Clone your fork: `git clone https://github.com/<your-user>/cron-impulse.git`
3.  Enter the repo: `cd cron-impulse`
